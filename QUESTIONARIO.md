...
- **Personagens:** Adrik Lahabrea, Leomir Holdheck, Oggam Vambag
...
- **Personagens:** Mason, Iorin Stenson
...
### ⬜ Novo Jogador _(copie este bloco)_
- **Nome:**
- **Avatar:**
- **Ativo:** sim / não
- **Bio:**
...
### ✅ Shadow
- **Classe:** Ladino · **Raça:** Drow · **Status:** Desconhecido · **Emoji:** 🐾
...
_Página:_ `/personagens/npcs`

### ✅ Gangue do Sirocco
Sirocco (🐍) · Suutha (⚔️) · Gunarsh (💪) · Caesar (🎖️) · Sarah (🌹) · Bolgrin (🔧) · Zelitch (🔮)

### ✅ Jarls dos Clãs do Norte
Drakø (🪓) · Kjartan (🔨) · Gunnhild (🛡️) · Ulf (⚙️)

### ✅ Clã Koongan e aliados
Roxak (🩸) · Uak (🔮) · Krogmar (⛓️) · Rexxar (👁️)
...
- O Pacto das Sombras Drow · *2º dia da Lua Negra, 1183*
...
_Página:_ `/album` · Imagens em `public/portraits/`

### ✅ Retratos cadastrados
| Personagem | Arquivo |
|---|---|
...
### ⬜ Novo Retrato
Coloque o arquivo `.png` em `public/portraits/` e informe o nome exato do arquivo aqui.
